# The main code for loading the simulated data sets and compute the dr, IPW.Q, Reg.T1, Reg.T2 estimators with coxph() for estimating the two nuisance parameters, 
# as well as the naive estimator and the full estimator.
