### The main code for simulation under the censoring scenario ('c2') that censoring is always after left truncation. 
...
# folder = paste("c2.datasets/T", Tmodel, "_Q", Qmodel, sep = "")
# dir.create(folder)
